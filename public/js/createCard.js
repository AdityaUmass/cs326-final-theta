...
console.log("hi");
let dictionary = {};
const response = await fetch("../../myAccountJSON");
if (response.ok) {
...
function renderAccountModal(postID, postEmails, body) {
  ...
  modalFooterButton.addEventListener("click", () =>
    createEmailLink(postID, postEmails.length)
  );
